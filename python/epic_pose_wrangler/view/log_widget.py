...
class LogWidget(logging.Handler):
    ...
    def __init__(self):
        ...
        self._debug_btn.setToolTip("Toggle Debug Messages")
        ...
        self._info_btn.setToolTip("Toggle Informational Messages")
        ...
        self._warning_btn.setToolTip("Toggle Warning Messages")
        ...
        self._error_btn.setToolTip("Toggle Error Messages")
        ...
        self._clear_log_btn.setToolTip("Clear Log Messages")
